...
/**
 * core/context/TodoContext
 * ----------------------------------------------------------------------
 * Fornece providers e consumers para um state de lista.
 *
 * Exemplo de como montar consumers, dispatchers e providers, com um
 * reducer mínimo, para state management simples e sem Redux.
 */
